...
namespace ReviewWebsite.Infrastructure.Migrations
{
    /// <inheritdoc />
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DinnerIds", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DinnerIds_Menus_MenuId",
                        column: x => x.MenuId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MenuItems", x => new { x.MenuItemId, x.MenuId, x.MenuSectionId });
                    table.ForeignKey(
